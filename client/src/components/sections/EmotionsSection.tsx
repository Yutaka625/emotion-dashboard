        ...
        {NON_NEUTRAL_EMOTIONS.map(e => {
          ...
          return (
            <div key={e} className="metric-card" style={{ borderLeft: `3px solid ${EMOTION_COLORS[e]}` }}>
              ...
              <div style={{ fontFamily: 'Roboto Mono, monospace', fontSize: '0.6rem', color: 'oklch(0.58 0.015 255)', marginTop: '2px' }}>
                支配: {pct.toFixed(1)}%
              </div>
            </div>
          );
      ...
      <div className="metric-card">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={prevalenceData} margin={{ top: 5, right: 10, bottom: 5, left: 0 }}>
            ...
            <XAxis dataKey="name" tick={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '0.72rem', fill: 'oklch(0.58 0.015 255)' }} />
            <YAxis tick={{ fontFamily: 'Roboto Mono, monospace', fontSize: '0.65rem', fill: 'oklch(0.58 0.015 255)' }} unit="%" />
            <Tooltip
      ...
      <div className="metric-card">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={dynamicsData} margin={{ top: 5, right: 10, bottom: 5, left: 0 }}>
            <CartesianGrid strokeDasharray="3 3" stroke="oklch(0.22 0.04 255)" vertical={false} />
            <XAxis dataKey="emotion" tick={{ fontFamily: 'Noto Sans JP, sans-serif', fontSize: '0.7rem', fill: 'oklch(0.58 0.015 255)' }} />
