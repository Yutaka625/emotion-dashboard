      ...
      <div className="metric-card">
        ...
        <div className="overflow-x-auto">
          <table className="text-xs">
            <thead>
              <tr>
                <th className="w-16 pb-2" style={{ fontFamily: 'Roboto Mono, monospace', fontSize: '0.6rem', color: 'oklch(0.52 0.015 250)' }}>
                  FROM↓ TO→
                </th>
                          ...
                          style={{
                            background: isDiag
                              ...
                              : count > 0
                                ...
                                : 'oklch(0.97 0.002 80)',
                            border: isDiag ? '1px dashed oklch(0.85 0.005 80)' : '1px solid oklch(0.92 0.004 80)',
                          }}
                        >
        ...
        <div className="space-y-2">
          {top10.map((t, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <span style={{ fontFamily: 'Roboto Mono, monospace', fontSize: '0.72rem', color: 'oklch(0.35 0.015 250)', width: '40px', textAlign: 'right' }}>
                {t.count}回
              </span>
            </div>
          ))}
